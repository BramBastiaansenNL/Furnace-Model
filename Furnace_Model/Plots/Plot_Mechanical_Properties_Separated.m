function Plot_Mechanical_Properties_Separated(t, T_m, M, X, fm)
    ...
    % Create tiled layout
    tile = tiledlayout(4, 1, "TileSpacing", "tight", "Padding", "compact");

    % Plot 1: Phase Fractions (X)
    nexttile(tile)
    h = plot(t_grid, X.X', 'LineWidth', 1.9); 
    ...
    % Plot 3: Ultimate Tensile Strength (UTS)
    nexttile(tile)
