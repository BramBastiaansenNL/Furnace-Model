function walls = Wall_Parameters(fm)
    ...
    walls.lambda1 = 0.0611;                           % Thermal conductivity of layer 1 (W/m·K)
    walls.lambda2 = 50;                             % Thermal conductivity of layer 2 (W/m·K)
    walls.rho1 = 200;                               % Density of layer 1 (kg/m³)
    walls.rho2 = 7800;                              % Density of layer 2 (kg/m³)
    walls.Cp1 = 900;                               % Specific heat capacity of layer 1 (J/kg·K)
