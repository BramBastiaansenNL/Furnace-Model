function wall = Wall_Side(walls)
    % Struct for side wall parameters

    %% Physical Parameters
    wall.L1 = 0.079;   % Thickness of layer 1 (m) insulated layer
    wall.L2 = 0.003;    % Thickness of layer 2 (m) metal sheet
    ...
    wall.epsilon_w = walls.epsilon;                % Radiative emmissivity of the interior wall
end