...
window_size = 15;
P_smooth = ...
    Smooth_Power_Moving_Average(time_measurement, P_measurement,  window_size, plot_measured_curves, fm);
...
%     Run_Calibration(calibration_algorithm, time_measurement, T_measurement, ...
%                     P_smooth, p_guess, fm);
